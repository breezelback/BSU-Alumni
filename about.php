    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-4 text-lg">Batangas State University</h1>
          <ul class="list-inline">
            <li class="list-inline-item"><a href="index.html" class="text-white"> JPLPC - Malvar Campus</a></li>
          </ul>
        </div>
      </div>
    </div>
		...
		<div class="row">
			<div class="col-lg-6 col-md-6">
				<div class="about-item pr-3 mb-5 mb-lg-0">
					...
					<h2 class="mt-3 mb-4 position-relative content-title">We are one of Philippines prestigious university.</h2>
					<p class="mb-5">Founded in 1903 with many other school branches within Batangas and other Univerty partners to provide excellent education for all Spartan!</p>
